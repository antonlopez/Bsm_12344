...
class Q4 extends Component{
    ...
    onButtonPressed(id, ch){
        ...
        this.props.answerUpdate({props:'q4', value: id});
    ...
    updateOther(text){
        this.props.resetCheckbox();
        this.props.answerUpdate({props: 'q4', value: text});
            ...
            >
                ...
                <View style={{paddingTop: 50}}>
                    ...
                    <CardSection style ={{paddingTop: 20, backgroundColor: 'transparent', borderBottomWidth: 0, alignSelf:'center'}}>
                        <Text style={styles.textStyle}> What is your religious background? </Text>
...
const mapToStateProps = state => {
    ...
    const { q4, counter } = state.studentInfo;

    const {ch1, ch2,ch3,ch4,ch5,ch6, otherBox} = state.checkbox;



    return {q4, counter, ch1,ch2,ch3,ch4,ch5,ch6,otherBox};

};



export default  connect(mapToStateProps, {answerUpdate, updateCheckbox, resetCheckbox}) (Q4);